...
try:
    _PARENT_CPU_AFFINITY = os.sched_getaffinity(0)
except AttributeError:  # Non-Linux platforms do not expose scheduler affinity.
    _PARENT_CPU_AFFINITY = None
...
def seed_worker(worker_id):  # noqa
    ...
    if _PARENT_CPU_AFFINITY is not None:
        os.sched_setaffinity(0, _PARENT_CPU_AFFINITY)

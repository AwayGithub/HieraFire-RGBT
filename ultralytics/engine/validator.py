...
class BaseValidator:
    ...
    def __call__(self, trainer=None, model=None):
        ...
        if self.training:
            ...
            # Prefer the input-channel contract stored by custom checkpoint models.
            # WaveMambaDetectionModel persists ch=6 but does not expose the legacy
            # DualStreamDetectionModel.backbone_rgb attribute checked below.
            channels = int(getattr(model.model, "ch", 3) or 3)
